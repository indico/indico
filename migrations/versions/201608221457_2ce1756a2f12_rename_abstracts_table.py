"""Add abstracts related tables

Revision ID: 2ce1756a2f12
Revises: 39a46a2830ab
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('proposed_type_id', sa.Integer(), nullable=True, index=True),
        sa.ForeignKeyConstraint(['abstract_id'], ['event_abstracts.abstracts.id']),
        sa.ForeignKeyConstraint(['proposed_track_id'], ['events.tracks.id']),
        sa.ForeignKeyConstraint(['proposed_type_id'], ['events.contribution_types.id']),
        sa.ForeignKeyConstraint(['track_id'], ['events.tracks.id']),
        sa.ForeignKeyConstraint(['user_id'], ['users.users.id']),
        sa.PrimaryKeyConstraint('id'),
