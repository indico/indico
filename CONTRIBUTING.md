...
> :no_entry_sign: **AI-generated contributions are not accepted.** All Pull Requests and issues must be written genuinely by the contributor. We do not accept content (code, comments, commit messages, issue or PR descriptions, documentation, etc.) that is generated by AI tools such as Codex, GitHub Copilot, Claude or similar. Such contributions will be rejected.
