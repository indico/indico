# -*- coding: utf-8 -*-
##
## $Id: sendSeminarsEmailJacques.py,v 1.3 2008/08/13 13:31:38 jose Exp $
##
...
data = {}
data['fromAddr'] = ""
data['toList'] = ["jacques.fichet@cern.ch","thomas.baron@cern.ch","audiovisual-support@cern.ch"]
#data['toList'] = ["thomas.baron@cern.ch"]
