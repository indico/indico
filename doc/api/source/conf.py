...
sys.path = [os.path.abspath('../../../'),os.path.abspath('../../../indico')] + sys.path
...
project = u'cds-indico'
copyright = u'2009, Indico Team'
...
latex_documents = [
  ('index', 'cds-indico.tex', u'cds-indico Documentation',
