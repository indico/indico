...
class BadgeDesignConfiguration:
    ...
    def __init__(self):
        ...
        self.items_actions = {
            "Title": (_("Title"), lambda x: x.get_personal_data().get('title', u'')),
            "Full Name": (_("Full Name"), lambda x: u"{} {}".format(x.get_personal_data().get('title', u''),
                                                                    x.get_full_name())),
            "Full Name (w/o title)": (_("Full Name (w/o title)"), lambda x: x.get_full_name()),
            "Full Name B": (_("Full Name B"), lambda x: u"{} {}".format(x.get_personal_data().get('title', u''),
            ...
            "Full Name C": (_("Full Name C"),
                            lambda x: u"{} {}".format(x.get_personal_data().get('title', u''),
            ...
            "Institution": (_("Institution"), lambda x: x.get_personal_data().get('affiliation', u'')),
            "Position": (_("Position"), lambda x: x.get_personal_data().get('position', u'')),
            "Address": (_("Address"), lambda x: x.get_personal_data().get('address', u'')),
            "Country": (_("Country"), lambda x: x.get_personal_data().get('country', u'')),
            "Phone": (_("Phone"), lambda x: x.get_personal_data().get('phone', u'')),
