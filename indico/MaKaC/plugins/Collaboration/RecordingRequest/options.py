...
globalOptions = [
    ...
    ("tab", {"description" : "Name of tab where the Recording Request plugin will be placed",
               "type": str,
    ...
    ("AgreementName", {"description" : "Agreement text",
               "type": str,
    ...
    ("recordingCapableRooms", {"description": "Rooms capable of recording",
                      "type": "rooms",
                      "defaultValue": [],
                      "editable": True,
                      "visible": True} ),
