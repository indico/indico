...
BTREE_MAX_UTC_DATE = pytz.timezone('UTC').localize(datetime.fromtimestamp(BTREE_MAX_INT))
BTREE_MIN_UTC_DATE = pytz.timezone('UTC').localize(datetime.fromtimestamp(BTREE_MIN_INT))
