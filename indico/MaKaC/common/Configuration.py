...
class Config:
    ...
    __styles = {
            "cdsagenda_olist":  ("CDS Agenda ordered list", "CDSAgendaOrdered.tpl"),
            "nicecompact":      ("Compact style", "Compact.tpl"),
            "ilc":              ("ILC style", "ILC.tpl"),
            "standard_inline_minutes": ("Indico style - inline minutes", "IndicoWithMinutes.tpl"),
            "lhcrrb":           ("LHC RRB", "LHCRBB.tpl"),
            "xml":              ("Simple xml", "SimpleXML.tpl"),
            "alice_meeting":    ("ALICE meeting", "ALICEMeeting.tpl"),
            "administrative3":  ("Administrative style 2", "Administrative3.tpl"),
            "administrative4":  ("Administrative style (all material)", "Administrative4.tpl"),
            "atlas":            ("ATLAS Meeting", "ATLASMeeting.tpl"),
            "text":             ("Simple text", "SimpleText.tpl"),
            "totem_meeting":    ("TOTEM Meeting", "TOTEMMeeting.tpl"),
            "administrative2":  ("Administrative style (with time)", "Administrative2.tpl"),
            "cdsagenda":        ("CDS Agenda style", "CDSAgenda.tpl"),
            "static":           ("Parallel", None),
            "sa":               ("Staff Association", "StaffAssociation.tpl"),
            "sa2":              ("Staff Association (with time)", "StaffAssociationWithTime.tpl"),
            "it":               ("IT style", "IT.tpl"),
            "cdsagenda_inline_minutes": ("CDS Agenda inline minutes", "CDSAgendaWithMinutes.tpl"),
            "lcg":              ("LCG style", "LCG.tpl"),
            "lhcb_meeting":     ("LHCb meeting", "LHCbMeeting.tpl"),
            "egee_meeting":     ("EGEE meeting", "EGEEMeeting.tpl"),
            "cms":              ("CMS Meeting", "CMSMeeting.tpl"),
            "standard":         ("Indico style", "Indico.tpl"),
            "lecture":          ("Lecture", "Lecture.tpl"),
            "egee_lecture":     ("EGEE lecture", "EGEELecture.tpl"),
            "event":            ("Event", "Event.tpl"),
            "jacow":            ("JACoW XML", "JACoW.tpl"),
            "endotofpet":       ("EndoTOFPET", "EndoTOFPET.tpl"),
            "pf":               ("Pension Fund", "PensionFund.tpl"),
            "crystal_clear":    ("Crystal Clear", "CrystalClear.tpl"),
            "openlab":          ("Openlab", "Openlab.tpl"),
    }
