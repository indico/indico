<?xml version='1.0'?>
<!-- $Id: cds_marcxml_subcontribution.xsl,v 1.2 2008/08/13 13:31:23 jose Exp $
...
<xsl:if test="./contribution/subcontribution/title!=''">
<datafield tag="245" ind1=" " ind2=" ">
  <subfield code="a"><xsl:value-of select="./contribution/subcontribution/title"/></subfield>
</datafield>
</xsl:if>
...
<datafield tag="300" ind1=" " ind2=" ">
  ...
  <subfield code="b"><xsl:value-of select="./contribution/subcontribution/videoFormat" /></subfield>
</datafield>
...
<xsl:if test="./contribution/subcontribution/allowedAccessGroups != '' and count(./contribution/subcontribution/allowedAccessGroups) != 0">
<datafield tag="506" ind1="1" ind2=" ">
    <subfield code="a">Restricted</subfield>
    <xsl:for-each select="./contribution/subcontribution/allowedAccessGroups/group">
...
<xsl:if test="./contribution/subcontribution/allowedAccessEmails != '' and count(./contribution/subcontribution/allowedAccessEmails) != 0">
<datafield tag="506" ind1="1" ind2=" ">
    <subfield code="a">Restricted</subfield>
    <xsl:for-each select="./contribution/subcontribution/allowedAccessEmails/email">
    <subfield code="d"><xsl:value-of select="." /></subfield>
    </xsl:for-each>
...
<datafield tag="520" ind1=" " ind2=" ">
  <subfield code="a">&lt;!--HTML--&gt;<xsl:value-of select="./contribution/subcontribution/abstract"/></subfield>
</datafield>
</xsl:if>
...
<xsl:if test="count(./contribution/subcontribution/CDSExperiment) != 0">
<datafield tag="693" ind1=" " ind2=" ">
  <subfield code="e"><xsl:value-of select="./contribution/subcontribution/CDSExperiment" disable-output-escaping="yes"/></subfield>
</datafield>
</xsl:if>
<xsl:if test="count(./contribution/subcontribution/speakers) != 0">
...
<datafield tag="856" ind1="4" ind2=" ">
  <subfield code="u">http://indico.cern.ch/subContributionDisplay.py?confId=<xsl:value-of select="./ID" disable-output-escaping="yes"/>&amp;contribId=<xsl:value-of select="./contribution/ID" disable-output-escaping="yes"/>&amp;subContId=<xsl:value-of select="./contribution/subcontribution/ID" disable-output-escaping="yes"/></subfield>
...
<datafield tag="970" ind1=" " ind2=" ">
  <subfield code="a">INDICO.<xsl:value-of select="./ID" disable-output-escaping="yes"/>c<xsl:value-of select="./contribution/ID" disable-output-escaping="yes"/>sc<xsl:value-of select="./contribution/subcontribution/ID" disable-output-escaping="yes"/></subfield>
</datafield>
<datafield tag="980" ind1=" " ind2=" ">
  <subfield code="a">Indico</subfield>
</datafield>
<xsl:if test="count(./contribution/subcontribution/CDSCategories) != 0">
<datafield tag="980" ind1=" " ind2=" ">
<xsl:for-each select="./contribution/subcontribution/CDSCategories/category">
