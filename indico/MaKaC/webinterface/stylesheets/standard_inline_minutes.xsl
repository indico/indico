<?xml version='1.0'?>
<!-- $Id: standard_inline_minutes.xsl,v 1.7 2009/06/22 15:15:31 eragners Exp $
...
<!-- GLobal object: Agenda -->
  <xsl:template match="iconf">
    ...
    <div class="eventWrapper">
      ...
      <xsl:call-template name="meetingEventBody"><xsl:with-param name="minutes">on</xsl:with-param></xsl:call-template>
