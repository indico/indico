<?xml version='1.0'?>
<!-- $Id: cdsagenda_inline_minutes.xsl,v 1.17 2009/06/19 12:44:11 jose Exp $
    ...
    <xsl:for-each select="./material">
      ...
      <br/>
          <table border="1" bgcolor="white" cellpadding="2" align="center">
            ...
            <tr>
                <td><p class="minutes"><xsl:value-of select="./minutesText" disable-output-escaping="yes"/></p></td>
            </tr>
          </table>
      </xsl:if>
    </xsl:for-each>
