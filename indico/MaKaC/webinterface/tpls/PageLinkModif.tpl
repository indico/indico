...
<table width="90%%" align="center" valign="middle" style="padding-top:20px" border="0">
	<tr>
		<td colspan="3" class="subgroupTitle"> <%= _("Internal page link")%></td>
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td bgcolor="white" width="100%%">&nbsp;&nbsp;&nbsp;%(linkContent)s</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <form action=%(toggleLinkStatusURL)s method="post">
            <td bgcolor="white" width="100%%" colspan="2">
               <b>&nbsp;&nbsp;&nbsp;%(linkStatus)s</b> <input type="submit" class="btn" value="%(changeStatusTo)s">
            </td>
        </form>
    </tr>
    <tr>
        <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("Page Type")%></span></td>
        <form action=%(toggleHomePageURL)s method="post">
            <td bgcolor="white" width="100%%" colspan="2">
               <b>&nbsp;&nbsp;&nbsp;%(homeText)s</b> <input type="submit" class="btn" value="%(changeHomeTo)s">
            </td>
        </form>
    </tr>
    <tr>
