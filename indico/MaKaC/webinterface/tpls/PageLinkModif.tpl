...
<table width="90%" align="center" valign="middle" style="padding-top:20px" border="0">
    ...
    <tr>
        ...
        <td bgcolor="white" width="100%">&nbsp;&nbsp;&nbsp;${ linkContent }</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <form action=${ toggleLinkStatusURL } method="post">
            <td bgcolor="white" width="100%" colspan="2">
               <b>&nbsp;&nbsp;&nbsp;${ linkStatus }</b> <input type="submit" class="btn" value="${ changeStatusTo }">
            </td>
        </form>
    </tr>
    <tr>
        <td nowrap class="titleCellTD"><span class="titleCellFormat"> ${ _("Page Type")}</span></td>
        <form action=${ toggleHomePageURL } method="post">
            <td bgcolor="white" width="100%" colspan="2">
               <b>&nbsp;&nbsp;&nbsp;${ homeText }</b> <input type="submit" class="btn" value="${ changeHomeTo }">
            </td>
        </form>
    </tr>
    <tr>
