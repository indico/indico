...
<% if withPrevNext: %>
    ...
    <td style="text-align: center;">
    	<form id="dateSelect" action="<%= urlHandlers.UHRoomBookingBookingList.getURL() %>" method="POST">
    		...
    		<a href="#" id="selectDateIcon"><img src="<%= Config.getInstance().getSystemIconURL('ical') %>" alt="Calendar" title="Select a Date" style="border: none; vertical-align: middle;" /></a>&nbsp;<%= verbosePeriod %>
    	</form>
    </td>
