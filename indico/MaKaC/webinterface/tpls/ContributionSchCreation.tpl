...
% if self_._rh._target.getConference().hasEnabledSection("cfa") and self_._rh._target.getConference().getAbstractMgr().hasAnyEnabledAbstractField():
${ additionalFields }
% else:
<tr>
...
<tr>
  ...
  <td bgcolor="white" width="100%">
    <textarea name="keywords" cols="60" rows="3">${ keywords }</textarea>
        ...
        <%include file="EventLocationInfo.tpl" args="parentRoomInfo=roomInfo(self_._rh._target), modifying=False, showParent=True, conf = False"/>
