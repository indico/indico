	...
	<tr>
        <td colspan="2">
            ...
            <table width="100%%" align="center" border="0" style="border-left: 1px solid #777777;border-top: 1px solid #777777;">
              <tr>
                <td colspan="3" class="groupTitle" style="background:#E5E5E5; color:gray"> <%= _("Details for")%> %(title)s %(fullName)s</td>
              </tr>
              <tr>
                <td bgcolor="white">
                      ...
                      <td>
                        <table width="100%%">
                          ...
                          <tr>
                            ...
                            <td bgcolor="white" width="100%%" valign="top" class="blacktext"><a href="%(mailURL)s">%(email)s</a></a></td>
                          </tr>
                          <tr>
                            <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("Address")%></span></td>
                            <td bgcolor="white" width="100%%" valign="top" class="blacktext"><pre>&nbsp;&nbsp;%(address)s</pre></td>
                          </tr>
                          <tr>
                            <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("Telephone")%></span></td>
                            <td bgcolor="white" width="100%%" valign="top" class="blacktext">&nbsp;&nbsp;&nbsp;%(telephone)s</td>
                          </tr>
                          <tr>
