    ...
    <tr>
       <td align="center">
            ...
            <table bgcolor="gray">
                <tr>
                    <td bgcolor="white" >
                        <center><b>&nbsp;%(title)s %(name)s %(surName)s&nbsp;</b></center>
                        <b>&nbsp; <%= _("Email")%> : </b>%(email)s&nbsp;
                    </td>
                </tr>
            </table>
            ...
            <br>
            <br>
             <%= _("If you are not this person, but it is your email address, please contact us")%> <a href="mailto:%(contactEmail)s"> <%= _("here")%></a>.
       </td>
    </tr>
</table>
