...
IndicoUI.executeOnLoad(function(){
    $("#inPlaceEditAddedInfo").append($(new RemoteSwitchButton(${"true" if addedInfo else "false"},
            Html.img({src:imageSrc("enabledSection")}), Html.img({src:imageSrc("disabledSection")}), "event.participation.addedInfo", "event.participation.addedInfo",{confId:${confId}}).draw().dom));
    $("#inPlaceEditDisplay").append($(new RemoteSwitchButton(${"true" if allowDisplay else "false"},
            Html.img({src:imageSrc("enabledSection")}), Html.img({src:imageSrc("disabledSection")}), "event.participation.allowDisplay", "event.participation.allowDisplay",{confId:${confId}}).draw().dom));
    $("#inPlaceEditAllowForApply").append($(new RemoteSwitchButton(${"true" if allowForApply else "false"},
            Html.img({src:imageSrc("enabledSection")}), Html.img({src:imageSrc("disabledSection")}), "event.participation.allowForApply", "event.participation.allowForApply",{confId:${confId}}).draw().dom));
    $("#inPlaceEditAutoAccept").append($(new RemoteSwitchButton(${"false" if autoAccept else "true"},
            Html.img({src:imageSrc("enabledSection")}), Html.img({src:imageSrc("disabledSection")}), "event.participation.autoAccept", "event.participation.autoAccept",{confId:${confId}}, reloadOptions).draw().dom));
    $("#inPlaceEditNotifyMgrNewParticipant").append($(new RemoteSwitchButton(${"true" if notifyMgrNewParticipant else "false"},
            Html.img({src:imageSrc("enabledSection")}), Html.img({src:imageSrc("disabledSection")}), "event.participation.notifyMgrNewParticipant", "event.participation.notifyMgrNewParticipant",{confId:${confId}}).draw().dom));
