<form method="POST" action="%(postURL)s">
    ...
    <table width="60%%" align="center" border="0" style="border-left: 1px solid #777777;padding-left:2px">
        ...
        <tr>
            ...
            <td bgcolor="white" width="100%%">&nbsp;
			<textarea name="description" cols="80" rows="10" wrap="soft">%(description)s</textarea></td>
        </tr>
        %(summary)s
        <tr>
        ...
        <!--<tr>
            ...
            <td bgcolor="white" width="100%%">&nbsp;
                <input type="text" size="2" name="sDay" value="%(day)s">-
                <input type="text" size="2" name="sMonth" value="%(month)s">-
                <input type="text" size="4" name="sYear" value="%(year)s">
