...
<form action=%(postURL)s method="POST">    
	<input type="hidden" name="toEmails" value="%(emails)s">
    <table width="80%%" align="center" border="0" style="border-left: 1px solid #777777">
        ...
        <tr>
            <td>From: </td>
  	        <td colspan="2"><input type="text" name="from" size="50" value="%(from)s"/></td>
        </tr>
        <tr>
            <td>
                To: 
        ...
        <tr>
            <td>Subject:</td>
	        <td><input type="text" name="subject" size="64" value="%(subject)s"/></td>
