...
<tr>
  <td bgcolor="white" width="80%%">
    <table width="100%%">
    <tr>
    <form action="%(grantSubmissionToAllSpeakersURL)s" method="POST">
      <td width="50%%">
        <input type="submit" class="btn" value="<%= _("Grant submission rights to all speakers")%>">
      </td>
    </form>
    <form action="%(removeAllSubmissionRightsURL)s" method="POST">
      <td>
    ...
    <tr>
    <form action="%(grantModificationToAllConvenersURL)s" method="POST">
      <td>
