...
<tr>
  <td>
    ...
    <tr>
      ...
      <td align="left" width="80%%"><input type="text" name="name" size="54" value="%(name)s"></td>
    </tr>
    <tr>
      <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("Description")%></span></td>
      <td align="left"><textarea name="description" cols="40" rows="6">%(description)s</textarea></td>
    </tr>
    <tr>
      <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("URL")%></span></td>
      <td align="left" width="80%%"><input type="text" name="url" size="54"  value="%(url)s"></td>
    </tr>
    <tr>
      <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("Place Name to match with<br><small>(e.g. CERN)</small>")%></span></td>
      <td align="left" width="80%%"><input type="text" name="placeName" size="54" value="%(placeName)s"></td>
    </tr>
    <tr>
      ...
      <td align="left"><textarea name="regexps" rows="2" cols="40">%(regexps)s</textarea></td>
    </tr>
    <tr>
