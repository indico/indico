  ...
  <tr>
    <td>
      <table>
        ...
        <tr>
          <td>
            <a href=${ matPkgURL }><img src=${ matPkgIconURL } alt="material package" border="0" style="vertical-align:middle"></a> <b> ${ _("Get material package")}</b>
          </td>
        </tr>
        <tr>
          <td>
            <a href=${ dvdURL }><img src=${ dvdIconURL } alt="DVD" border="0" style="vertical-align:middle"></a> <b> ${ _("Offline web site for your meeting")}</b><font color="red"> ${ offlsiteMsg }</font>
          </td>
        </tr>
        <tr>
          <td>
