<div class="container" style="max-width: 700px;">
    ...
    <div class="indicoHelp">
        ...
        <div class="content">
            % if _session.user and _session.user.is_admin:
            <div class="item clearfix">
                <div class="icons">
                <a href="ihelp/html/AdminGuide/index.html" style="vertical-align: top">
                        Web
                </a> |
                <a href="ihelp/pdf/IndicoAdminGuide.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a>
                </div>
            ...
            <div class="item clearfix">
                ...
                <a href="ihelp/pdf/IndicoUserGuide.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a>
                </div>
        ...
        <div class="content">
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/PaperReviewingGuides/PaperReviewingRoles/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoReviewingRole.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/PaperReviewingGuides/PaperReviewingManagers/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoReviewingManager.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/PaperReviewingGuides/PaperReviewingReferees/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoReferee.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/PaperReviewingGuides/PaperReviewingReviewers/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoContentReviewer.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/PaperReviewingGuides/PaperReviewingEditors/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoLayoutReviewer.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/PaperReviewingGuides/PaperReviewingAuthors/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoAuthor.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
        ...
        <div class="content">
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/QuickStartGuides/QSGContributionManager/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoQSGContributionManager.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/QuickStartGuides/QSGSessionManager/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoQSGSessionManager.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/QuickStartGuides/QSGSubmitter/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoQSGSubmitter.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/QuickStartGuides/QSGTrackCoordinator/index.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoQSGTrackCoordinator.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
        ...
        <div class="content">
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/FAQ/FAQ.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoFAQ.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
            ...
            <div class="item clearfix">
                <div class="icons"><a href="ihelp/html/Glossary/Glossary.html" style="vertical-align: top">
                    ...
                    <a href="ihelp/pdf/IndicoGlossary.pdf"><img src="${Config.getInstance().getImagesBaseURL()}/pdf_small.png" alt="PDF version"></a></div>
