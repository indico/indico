<form action=%(postURL)s method="POST">
    <table width="80%%" align="center" border="0" style="border-left: 1px solid #777777">
        ...
        <tr>
            ...
            <td align="left">
            <%= _("event start date offset:")%> <input type="text" name="aoffset1" size="2" value="%(aoffset1)s"> <%= _("""days -> 
            event end date offset:""")%> <input type="text" name="aoffset2" size="2" value="%(aoffset2)s"> days
            </td>
        </tr>
        <tr>
            <td nowrap class="titleCellTD"><span class="titleCellFormat"> <%= _("Departure dates (offset)")%></span></td>
            <td align="left">
            <%= _("event start date offset:")%> <input type="text" name="doffset1" size="2" value="%(doffset1)s"> <%= _("""days -> 
            event end date offset:""")%> <input type="text" name="doffset2" size="2" value="%(doffset2)s"> days
            </td>
        </tr>
        <tr>
