...
<tr>
  <td>
    <OBJECT id="VIDEO" width="480" height="430" // Player height = display size + 70 pixels of controls and status bar which cannot be removed, even though the ShowStatusBar is set to false
				...
				type="application/x-oleobject">
					...
					width="480" height="403" src="%(url)s" // Player height = display size + 43 pixels of controls
					autostart="True"
					showcontrols="True"
					ShowStatusBar="false"
					ShowDisplay="false">
  ...
  <td><p>Playing Windows Media file...<br><a href="%(downloadurl)s">Download file</a></p>
  </td>
</tr>
</table>
