    ...
    <tr>
      <td colspan="2">
        ...
        <table width="60%%" align="center" border="0" style="border-left: 1px solid #777777">
		  ...
		  <tr>
		    <td colspan="3" bgcolor="white" width="100%%" valign="top" style="color:red;padding-top:10px;padding-bottom:10px">%(msg)s</td>
		  </tr>
          <tr>
            <td nowrap class="titleCellTD"><span class="titleCellFormat"><%= _("User Name")%></span></td>
            <td bgcolor="white" width="100%%" valign="top" class="blacktext">
            	&nbsp;&nbsp;
            	<input type="text" name="login" value="%(login)s" size="40" %(disabledLogin)s>
            	%(hiddenLogin)s
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="white" width="100%%" valign="top" class="blacktext">&nbsp;&nbsp;&nbsp;<select name="system" %(disabledSystem)s>
              %(systemList)s
            </td>
          </tr>
          <tr>
