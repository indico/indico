<form action=%(postURL)s method="POST">
    <table width="80%%" align="center" border="0" style="border-left: 1px solid #777777">
        ...
        <tr>
          ...
          <td bgcolor="white" class="blacktext" width="100%%">
            <input type="checkbox" name="billable" size="60" %(billable)s><%= _("(uncheck if it is not billable)") %>
          </td>
        </tr>
        <tr>
          <td class="titleCellTD"><span class="titleCellFormat"><%= _("Price") %></span></td>
          <td bgcolor="white" class="blacktext" width="100%%">
            <input type="text" name="price" size="60" value="%(price)s">
          </td>
        </tr>
        <tr>
          <td class="titleCellTD"><span class="titleCellFormat">Price is per place</span></td>
          <td bgcolor="white" class="blacktext" width="100%%">
            <input type="checkbox" name="pricePerPlace" size="60" %(pricePerPlace)s><%= _("(uncheck if the price is the same no matter how many places are chosen)") %>
          </td>
        </tr>
		<tr>
          <td>&nbsp;</td>
