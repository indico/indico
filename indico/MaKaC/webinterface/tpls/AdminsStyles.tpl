      ...
      <tr>
        <td>
          ...
          <tr style="background-color: ${"#faa" if not styleMgr.isCorrectStyle(style) else "lightgreen"}">
            ...
            % else:
            <a href="${urlHandlers.UHAdminsDeleteStyle.getURL(templatefile=style)}"  data-confirm='${"Are you sure you want to delete this style?"}' data-title='${"Delete style"}'><img border="0" src="${deleteIconURL}" alt="${ _("delete this style")}"></a>
            % endif
            </td>
          </tr>
          % endfor
