    ...
    <tr>
        <td width="100%">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="outervtab">
                ...
                <!-- Headers above "E-Payment configuration" -->
                ${ context }
                <!-- End of headers above "E-Payment configuration" -->

                <!-- Header of "E-Payment configuration" -->
                <tr>
                            ...
                            <tr>
                                <td width="${ titleTabPixels }px" class="vtabmenu" valign="top">
                                    <table cellpadding="0" cellspacing="0" border="0" width="${ titleTabPixels }px">
                                        <tr>
                                            <td width="27px">&nbsp;</td>
                                            <td align="right" class="menutitle" nowrap> ${ _("E-Payment configuration")}</td>
                                        </tr>
                                    </table>
                                </td>
      ...
      <!-- End of header of "E-Payment configuration" -->
