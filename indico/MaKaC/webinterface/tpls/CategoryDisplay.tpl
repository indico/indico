...
<ul>
        ...
        % endif
            % if categ.conferences:
                <li><a id="exportIcal${categ.getUniqueId()}" class="fakeLink exportIcal" data-id="${categ.getUniqueId()}">${ _("iCal export")}</a><span><%include file="CategoryICalExport.tpl"/></span>|</li>
