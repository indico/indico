<table align="center" width="100%">
    ...
    <tr>
		...
		<%if loginURL:%> <a class="loginHighlighted" style="padding:4px 17px" href="<%= loginURL%>"><strong style="color: white;">Login</strong></a>&nbsp;<%= _("or enter the modification key here:")%><%end%>
