<table align="center" width="100%">
    ...
    <tr>
        ...
        %if not _session.user:
            <a class="loginHighlighted" style="padding:4px 17px" href="${ url_for_login(request.relative_url) }"><strong style="color: white;">Login</strong></a>&nbsp;${ _("or enter the modification key here:")}
        %else:
