    ...
    <tr>
        <td>
			...
			<table border ="0" cellpadding="4" cellspacing="1"
                                width="100%%">	
			     <tr>
                                <td bgcolor="#E5E5E5"><center><b><font size="+1" color="#3366AA"><%= _("Script detected in submitted data")%>: %(msg)s</font></b></center></td>
                            </tr>
                        </table>
           	   </td>
                </tr>
                <tr>
                    <td align="center"><br><font size="+1" color="red"><u><%= _("Scripts are forbidden to avoid cross site scripting attacks")%></u></font><br><br></td>
                </tr>
                <tr>
                    <td>
