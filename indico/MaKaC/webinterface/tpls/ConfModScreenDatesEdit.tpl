...
<table width="80%%" align="center" border="0" style="border-left: 1px solid #777777">
    ...
    <tr>
        ...
        <td bgcolor="white" width="100%%">
            <table>
                <tr>
                    <td><input type="radio" name="start_date" value="conference"%(start_date_conf_sel)s onclick="startdisable()"><%= _("Same as for the event")%>: %(conf_start_date)s</td>
                </tr>
                <tr>
                    <td>
                        <input type="radio" name="start_date" value="own"%(start_date_own_sel)s onclick="startenable()" ><%= _("Different one")%>:                       
                        <input type="text" id="sDay" name="sDay" size="2" value=%(sDay)s>-<input type="text" id="sMonth" name="sMonth" size="2" value=%(sMonth)s>-<input type="text" id="sYear" name="sYear" size="4" value=%(sYear)s>
                        <input type="text" id="sHour" name="sHour" size="2" value=%(sHour)s>:<input type="text" id="sMin" name="sMin" size="2" value=%(sMin)s>                    
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        ...
        <td bgcolor="white" width="100%%">
            <table>
                <tr>
                    <td><input type="radio" name="end_date" value="conference"%(end_date_conf_sel)s onclick="enddisable()"><%= _("Same as for the event")%>: %(conf_end_date)s</td>
                </tr>
                <tr>
                    <td>
                        <input type="radio" name="end_date" value="own"%(end_date_own_sel)s onclick="endenable()" ><%= _("Different one")%>: 
                        <input type="text" id="eDay" name="eDay" size="2" value=%(eDay)s>-<input type="text" id="eMonth" name="eMonth" size="2" value=%(eMonth)s>-<input type="text" id="eYear" name="eYear" size="4" value=%(eYear)s>
                        <input type="text" id="eHour" name="eHour" size="2" value=%(eHour)s>:<input type="text" id="eMin" name="eMin" size="2" value=%(eMin)s>
                    </td>
                </tr>
            </table>
        </td>
