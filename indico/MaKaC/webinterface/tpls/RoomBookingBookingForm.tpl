...
<form id="bookingForm" method="POST">
    ...
    <%include file="RoomBookingRoomMiniDetails.tpl" args="room=room,event=event,endpoints=endpoints,allow_room_change=not bool(reservation),clone_booking=clone_booking"/>
