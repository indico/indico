                ...
                <tr>
                    <td colspan="1">
                        <table border="0" cellpadding="2" cellspacing="0" 
                                ...
                                bgcolor="#000060">
                            <tr>
                                <td width="35"><img src="%(meetingIcon)s" width="32" height="32" alt="lecture" border="0"></td>
                                <td class="headerselected" align="left"><b><strong><font size="+2" face="arial" color="white">%(title)s</font></strong></b><br><small></small></td>
                            </tr>
                        </table>
                    </td>
                </tr>
