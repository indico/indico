                ...
                <tr>
                    <td colspan="1">
                        <table border="0" cellpadding="2" cellspacing="0" 
                                ...
                                bgcolor="#000060">
                            <tr>
                                <td width="35"><img src="%(meetingIcon)s" width="32" height="32" alt="lecture" border="0"></a></td>
                                <td class="headerselected" align="left"><b><strong><font size="+2" face="arial" color="white">%(modifyIcon)s%(title)s</font></strong></b><br></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td>
                        <table border="0" bgcolor="#f0c060" cellpadding="2" 
                            ...
                            <tr>
                                ...
                                <td><font size="-1">%(dateInterval)s</font></td>
                            </tr>
                            %(description)s
                            %(location)s
                            %(room)s
