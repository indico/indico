        ...
        <td align="center">
            ...
            <table align="center"><tr><td>
                ...
                <table bgcolor="gray" align="center"><tr><td bgcolor="white">
                    ...
                    <form action=%(sendReportURL)s method="post">
                        <br>
                        <input type="hidden" name="systemComments" value="%(msg)s">
                        ...
                        <textarea name="comments" rows="10" cols="100"></textarea><br><br>
                         <%= _("Your email address")%> : <input type="text" name="email" value="%(email)s" size="40"><br><br>
