...
<table style="-moz-border-radius: 5px 5px 5px 5px; border:1px solid #999999;" width="100%" cellspacing="0" cellpadding="0">
    <tr>
        <td bgcolor="#E5E5E5" style="-moz-border-radius-bottomleft: 5px; -moz-border-radius-topleft: 5px;">
            <input type="checkbox" name="selected_secondary_authors" value="${ auth_id }">
        </td>
                    ...
                    <td>
                        <table cellpacing="0" cellpadding="2">
                            ...
                            <tr>
                                ...
                                <td bgcolor="white" nowrap id="tdSecondaryPresenter${ auth_id }" class="${"tdSelected" if auth_speaker == 'checked' else "tdNotSelected"}" style="-moz-border-radius: 5px 5px 5px 5px; padding-right:6px; width:100%;">
                                    <input type="checkbox" id="secondary_auth_speaker${ auth_id }" name="auth_speaker" value="${ auth_id }" ${ auth_speaker } onClick="switchSecondaryAuthorBackground('${ auth_id }')"> ${ _("This co-author will be also a <b>presenter</b>")}
                               </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <input type="hidden" name="auth_address" value="${ auth_id }">
            </table>
        </td>
