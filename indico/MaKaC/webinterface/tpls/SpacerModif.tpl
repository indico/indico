...
<table width="90%%" align="center" valign="middle" style="padding-top:20px" border="0">
    ...
    <tr>
        ...
        <table><tr><td>
            <a href=%(moveUpURL)s>&nbsp;&nbsp;&nbsp;<img class="imglink" src=%(imageUpURL)s alt="move up"></a>  <%= _("move up the spacer")%>
            </td></tr>
            <tr><td>
            <a href=%(moveDownURL)s>&nbsp;&nbsp;&nbsp;<img class="imglink" src=%(imageDownURL)s alt="<%= _("move down")%>"></a>  <%= _("move down the spacer")%>
            </td></tr></table>
        </td>
    </tr>
    <tr>
