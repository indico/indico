...
from .parse import RE_SPLIT, parse_input
...
class ColorBytes(bytes):
    """bytes subclass, .decode() overridden to return str subclass instance."""
    ...
    def decode(self, encoding='utf-8', errors='strict'):
        ...
        return original_class(super().decode(encoding, errors))
...
class ColorStr(str):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        # Parse string.
        value_markup = args[0] if args else ''  # e.g. '{red}test{/red}'
        value_colors, value_no_colors = parse_input(value_markup, keep_tags)
    ...
    def __repr__(self):
        ...
        return f'{self.__class__.__name__}({repr(self.value_colors)})'
    ...
    def encode(self, encoding=None, errors='strict'):
        ...
        :param str errors: Error handling scheme.
        """
        return ColorBytes(super().encode(encoding, errors), original_class=self.__class__)
    ...
    def decode(self, encoding=None, errors='strict'):
        ...
        :param str errors: Error handling scheme.
        """
        return self.__class__(super().decode(encoding, errors), keep_tags=True)
    ...
    def format(self, *args, **kwargs):
        ...
        """
        return self.__class__(super().format(*args, **kwargs), keep_tags=True)
    ...
    def join(self, iterable):
        ...
        """
        return self.__class__(super().join(iterable), keep_tags=True)
