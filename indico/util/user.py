...
def create_user(user_form, handler, pending_user=None):
    ...
    from indico.modules.users.models.users import User, RegistrationRequest
    ...
    _remove_all_registration_requests(user.email)
    return user, identity


def _remove_all_registration_requests(email):
