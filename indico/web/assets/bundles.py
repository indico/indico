...
def register_all_js(env):
    ...
    module_js = {
        ...
        'contributions': rjs_bundle('modules_contributions',
                                    *namespace('js/indico/modules/contributions', 'common.js', 'types_dialog.js')),
        ...
        'timetable': rjs_bundle('modules_timetable',
                                *namespace('js/indico/modules/timetable/timetable', 'Management.js', 'Filter.js',
                                           ...
                                           'Actions.js')),
        'sessions': rjs_bundle('modules_sessions',
                               *namespace('js/indico/modules/sessions', 'common.js', 'types_dialog.js')),
