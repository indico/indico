...
legacy_endpoints = set([
    ...
    'categoryModification-clearCache', 'categoryModification-clearConferenceCaches', 'categoryStatistics',
    'categoryTasks', 'categoryTasks-taskAction', 'categoryTools', 'categoryTools-delete', 'categOverview',
    'categOverview-rss', 'changeLang', 'confAbstractBook', 'confAuthorIndex', 'confDisplayEvaluation',
    ...
    'confModifCFA-absFieldUp', 'confModifCFA-abstractFields', 'confModifCFA-addAbstractField',
    'confModifCFA-changeStatus', 'confModifCFA-editAbstractField', 'confModifCFA-makeTracksMandatory',
    'confModifCFA-modifyData', 'confModifCFA-performAddAbstractField', 'confModifCFA-performModifyData',
    ...
    'confModifRegistrationForm-actionSection', 'confModifRegistrationForm-actionStatuses',
    'confModifRegistrationForm-addAccommodationType', 'confModifRegistrationForm-addGeneralField',
    'confModifRegistrationForm-addSession', 'confModifRegistrationForm-addSocialEvent',
    'confModifRegistrationForm-changeStatus', 'confModifRegistrationForm-dataModif',
    'confModifRegistrationForm-enablePersonalField', 'confModifRegistrationForm-enableSection',
    'confModifRegistrationForm-modifAccommodation', 'confModifRegistrationForm-modifAccommodationData',
    'confModifRegistrationForm-modifFurtherInformation', 'confModifRegistrationForm-modifFurtherInformationData',
    'confModifRegistrationForm-modifGeneralField', 'confModifRegistrationForm-modifGeneralSection',
    'confModifRegistrationForm-modifGeneralSectionData', 'confModifRegistrationForm-modifReasonParticipation',
    'confModifRegistrationForm-modifReasonParticipationData', 'confModifRegistrationForm-modifSessions',
    'confModifRegistrationForm-modifSessionsData', 'confModifRegistrationForm-modifSocialEvent',
    'confModifRegistrationForm-modifSocialEventData', 'confModifRegistrationForm-modifStatus',
    'confModifRegistrationForm-modifyAccommodationType', 'confModifRegistrationForm-modifySessionItem',
    'confModifRegistrationForm-modifySocialEventItem', 'confModifRegistrationForm-performAddAccommodationType',
    'confModifRegistrationForm-performAddGeneralField', 'confModifRegistrationForm-performAddSession',
    'confModifRegistrationForm-performAddSocialEvent', 'confModifRegistrationForm-performDataModif',
    'confModifRegistrationForm-performModifAccommodationData',
    'confModifRegistrationForm-performModifFurtherInformationData',
    'confModifRegistrationForm-performModifGeneralField', 'confModifRegistrationForm-performModifGeneralSectionData',
    'confModifRegistrationForm-performModifReasonParticipationData',
    'confModifRegistrationForm-performModifSessionsData', 'confModifRegistrationForm-performModifSocialEventData',
    'confModifRegistrationForm-performModifStatus', 'confModifRegistrationForm-performModifyAccommodationType',
    'confModifRegistrationForm-performModifySessionItem', 'confModifRegistrationForm-performModifySocialEventItem',
    ...
    'JSContent-getVars', 'logOut', 'logoutSSOHook', 'materialDisplay', 'materialDisplay-accessKey', 'myconference',
    ...
    'signIn-sendLogin', 'signIn-unactivatedAccount', 'subContributionDisplay', 'subContributionDisplay-marcxml',
    'subContributionModification', 'subContributionModification-data', 'subContributionModification-materials',
    'subContributionModification-materialsAdd', 'subContributionModification-modifData', 'subContributionTools',
    'subContributionTools-delete', 'taskManager', 'trackAbstractModif', 'trackAbstractModif-abstractAction',
    'trackAbstractModif-abstractToPDF', 'trackAbstractModif-accept', 'trackAbstractModif-commentEdit',
    'trackAbstractModif-commentNew', 'trackAbstractModif-commentRem', 'trackAbstractModif-comments',
    'trackAbstractModif-directAccess', 'trackAbstractModif-markAsDup', 'trackAbstractModif-proposeForOtherTracks',
    'trackAbstractModif-proposeToBeAcc', 'trackAbstractModif-proposeToBeRej', 'trackAbstractModif-reject',
    'trackAbstractModif-unMarkAsDup', 'trackModContribList', 'trackModContribList-contribAction',
    'trackModContribList-contribQuickAccess', 'trackModContribList-contribsToPDF',
    'trackModContribList-participantList', 'trackModifAbstracts', 'trackModifCoordination', 'trackModification',
    'trackModification-modify', 'trackModification-performModify', 'updateNews', 'userAbstracts', 'userAbstracts-pdf',
    'userAPI', 'userAPI-block', 'userAPI-create', 'userAPI-delete', 'userBaskets', 'userDashboard', 'userDetails',
