...
with event_mgmt.add_prefixed_rules('/session/<sessionId>'):
    ...
    event_mgmt.add_url_rule('/contribution/<contribId>/material/browse/<materialId>',
                            ...
                            rh_as_view(contribMod.RHContribModifMaterialBrowse))

    # Protection
    event_mgmt.add_url_rule('/contribution/<contribId>/access/', 'contributionAC',
                            rh_as_view(contribMod.RHContributionAC), methods=('GET', 'POST'))
    ...
    event_mgmt.add_url_rule('/contribution/<contribId>/subcontribution/<subContId>/modify/save',
                            ...
                            rh_as_view(subContribMod.RHSubContributionModifData), methods=('POST',))
