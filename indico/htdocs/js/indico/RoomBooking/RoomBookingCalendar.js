...
type ("RoomBookingManyRoomsCalendarDrawer", ["RoomBookingCalendarDrawer"],
        {
            ...
            drawContent: function(){
                ...
                return this.data.days.length != 0 ? Html.div({},days) : Html.div({style:{width:pixels(700), margin: '2em auto'}, className: 'info-message'}, $T('No results found in the given period of time.'));
            }
        },
        /**
         * Object used to draw roombooking calendar out of reservation data.
