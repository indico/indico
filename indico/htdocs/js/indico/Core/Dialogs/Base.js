...
type("ErrorReportDialog", ["ServiceDialog"],
     {
         ...
         draw: function() {
             ...
             return this.ExclusivePopup.prototype.draw.call(
                 ...
                 Html.div(
                     {},
                     Html.div({style:{marginBottom: pixels(10), width: pixels(300), textAlign: 'center'}},'An error has occurred while processing your request. We advise you to submit an error report, by clicking "Send report".'),
                     Html.div({style:{color: 'red', marginBottom: pixels(10), width: pixels(300), textAlign: 'center'}},
