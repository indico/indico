...
Create Date: 2021-09-16 11:27:39.335488
"""
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('registration_id', sa.Integer(), nullable=False, index=False),
        sa.Column('registration_tag_id', sa.Integer(), nullable=False, index=False),
        sa.ForeignKeyConstraint(['registration_id'], ['event_registration.registrations.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['registration_tag_id'], ['event_registration.registration_tags.id'], ondelete='CASCADE'),
...
def downgrade():
    op.drop_table('registrations_registration_tags', schema='event_registration')
