...
def upgrade():
    ...
    op.add_column('events', sa.Column('default_check_type_id', sa.Integer(), nullable=True), schema='events')
    ...
    conn.execute('''UPDATE events.events SET default_check_type_id = %s''', (check_type_id))
