...
class MapAreasPage extends React.Component {
    ...
    componentDidMount() {
        const {actions: {fetchMapAreas}} = this.props;
        fetchMapAreas();
    ...
    editArea = (evt) => {
        ...
        const {actions: {updateMapAreas}} = this.props;
        const editedAreas = [];
    ...
    deleteMapAreas = (evt) => {
        ...
        const {actions: {deleteMapAreas}} = this.props;
        const deletedAreas = [];
    ...
    renderForm = ({handleSubmit}) => {
        ...
        return (
            <Modal onClose={() => this.setState({areaProps: null})}
                ...
                <Modal.Header>
                    {isNewArea ? (
                        <Translate>Create new area</Translate>
                    ) : (
                        <Translate>Update area</Translate>
                    )}
                </Modal.Header>
                <Modal.Content>
                ...
                <Modal.Actions>
                    <FinalSubmitButton form="map-area-form"
    ...
    render() {
        ...
        const bounds = defaultArea ? new Leaflet.LatLngBounds([
