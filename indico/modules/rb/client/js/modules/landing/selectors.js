...
export const hasUpcomingBookings = ({landing: {upcomingBookings: {data}}}) => !!(data && data.length);
export const hasFetchedUpcomingBookings = ({landing: {upcomingBookings: {request}}}) => request.state === 'success';
