...
_bp.add_url_rule('/api/room-permission-types', 'room_permission_types', misc.RHRoomPermissionTypes)
_bp.add_url_rule('/api/location-permission-types', 'location_permission_types', misc.RHLocationPermissionTypes)
