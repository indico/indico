...
from indico.modules.users.controllers import (RHAcceptRegistrationRequest, RHAdmins, RHExportDashboardICS,
                                              RHManageProfilePicture, RHPersonalData, RHProfilePicture,
                                              RHProfilePictureDelete, RHProfilePictureDisplay, RHProfilePictureGravatar,
                                              RHProfilePicturePage, RHRegistrationRequestList,
...
with _bp.add_prefixed_rules('/<int:user_id>'):
    ...
    _bp.add_url_rule('/profile/picture/<any(standard, gravatar, identicon):type>', 'profile_picture_gravatar',
                     RHProfilePictureGravatar)
    ...
    _bp.add_url_rule('/profile/picture/<any(standard, identicon, gravatar, custom):type>', 'manage_profile_picture',
                     RHManageProfilePicture, methods=('POST', 'DELETE'))
