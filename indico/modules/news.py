...
class NewsItem(Persistent):
    ...
    @Retrieves(['indico.modules.news.NewsItem'], 'id')
    def getId(self):
        return self._id
    ...
    @Retrieves(['indico.modules.news.NewsItem'], 'creationDate', Conversion.datetime)
    def getAdjustedCreationDate(self, tz = 'UTC'):
        return getAdjustedDate(self.getCreationDate(), tz = tz)

    @Retrieves(['indico.modules.news.NewsItem'], 'text')
    def getContent(self):
    ...
    @Retrieves(['indico.modules.news.NewsItem'], 'title')
    def getTitle(self):
        return self._title
    ...
    @Retrieves(['indico.modules.news.NewsItem'], 'type')
    def getType(self):
        return self._type
    ...
    @Retrieves(['indico.modules.news.NewsItem'], 'humanReadableType')
