...
class RegistrationListGenerator(ListGeneratorBase):
    ...
    def __init__(self, event, regform):
        super(RegistrationListGenerator, self).__init__(event, entry_parent=regform)
    ...
    def _get_non_custom_columns(self, ids):
        """
        Retrieve information needed for the header of the non custom columns (basic and special).
    ...
    def get_reg_list_kwargs(self):
        ...
        other_columns = self._get_non_custom_columns(other_item_ids)
