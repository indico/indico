...
from indico.modules.registration_form.models.items import PersonalDataType
...
class Registration(db.Model):
    ...
    def can_be_withdrawn(self):
        from indico.modules.registration_form.models.forms import ModificationMode
...
class RegistrationData(StoredFileMixin, db.Model):
    ...
    @property
    def user_data(self):
        from indico.modules.registration_form.fields.simple import KEEP_EXISTING_FILE_UUID
