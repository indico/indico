...
_bp.add_url_rule('/manage/registration/<int:reg_form_id>/registrations/field/<int:field_id>/upload',
                 'upload_file_management', reglists.RHRegistrationUploadFile, methods=('POST',))
_bp.add_url_rule('/manage/registration/<int:reg_form_id>/registrations/field/<int:field_id>/upload-picture',
...
_bp.add_url_rule('/registrations/<int:reg_form_id>/', 'display_regform', display.RHRegistrationForm,
                 methods=('GET', 'POST'))
_bp.add_url_rule('/registrations/<int:reg_form_id>/field/<int:field_id>/upload',
                 'upload_registration_file', display.RHUploadRegistrationFile, methods=('POST',))
_bp.add_url_rule('/registrations/<int:reg_form_id>/field/<int:field_id>/upload-picture',
