...
from indico.core.signals import event_management
...
def render_event_header(event, conference_layout=False, theme=None, theme_override=False):
    ...
    show_management_button = bool(not config.CHECK_ACTION_PERMISSIONS or
                                  values_from_signal(event_management.management_url.send(event)))
