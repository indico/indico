...
class MathjaxMixin:
    def _getHeadContent(self):
        return (render('js/mathjax.config.js.tpl') +
                u'\n'.join(u'<script src="{0}" type="text/javascript"></script>'.format(url)
...
class WPManageAbstracts(MathjaxMixin, WPJinjaMixin, WPConferenceModifBase):
    ...
    def _getHeadContent(self):
        return WPConferenceModifBase._getHeadContent(self).decode('utf-8') + MathjaxMixin._getHeadContent(self)
...
class WPDisplayAbstractsBase(MathjaxMixin, WPJinjaMixin, WPConferenceDefaultDisplayBase):
    ...
    def _getHeadContent(self):
        return WPConferenceDefaultDisplayBase._getHeadContent(self).decode('utf-8') + MathjaxMixin._getHeadContent(self)
