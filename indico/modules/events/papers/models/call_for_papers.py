...
class CallForPapers:
    ...
    limit_review_cycles = EventSettingProperty(paper_reviewing_settings, 'limit_review_cycles')
    max_review_cycles = EventSettingProperty(paper_reviewing_settings, 'max_review_cycles')
