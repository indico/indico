...
from indico.modules.events.requests.controllers import (RHRequestsEventSettings, RHRequestsEventRequestDetails,
...
# Event management
_bp.add_url_rule('/event/<confId>/manage/requests/', 'event_requests', RHRequestsEventSettings)
