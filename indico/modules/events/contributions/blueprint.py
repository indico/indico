...
from indico.modules.events.contributions.controllers import (RHContributionREST, RHContributionPersonList,
                                                             RHContributions, RHCreateContribution,
                                                             RHDeleteContributions, RHEditContribution)
