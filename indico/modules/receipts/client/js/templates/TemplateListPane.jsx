...
import {CollapsibleContainer, RequestConfirmDelete} from 'indico/react/components';
  ...
  return (
    <div styleName="template-list">
      ...
      {!!otherTemplates.length && (
        <section>
          <CollapsibleContainer title={Translate.string('Other templates')} titleSize="small">
            <table className="i-table-widget">
              <tbody>
