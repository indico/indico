...
from indico.web.forms.widgets import SwitchWidget, SelectizeWidget
...
class _FolderNameAutoCompleteField(HiddenField):
    widget = SelectizeWidget({'valueField': 'name', 'create': True,
                              'dropdownClass': 'selectize-dropdown folder-name-dropdown'})
...
class AttachmentFolderForm(IndicoForm):
    title = _FolderNameAutoCompleteField(_("Name"), [DataRequired()], description=_("The name of the folder."))
