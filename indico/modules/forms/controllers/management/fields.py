...
from indico.modules.forms.models.items import RegistrationFormItemType, RegistrationFormText
...
class GeneralFieldDataSchema(mm.Schema):
    ...
    def _check_show_if_id(self, field_id, **kwargs):
        from indico.modules.forms.models.form_fields import RegistrationFormItem
        if field_id is None:
            return
        field = self.context['field']
