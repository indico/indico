...
from indico.modules.events.registration.controllers.management.fields import (ManageRegFormFieldBaseMixin,
...
class RHCategoryRegistrationFormToggleTextState(RegistrationFormToggleTextStateMixin,
                                                RHCategoryManageRegformFieldBase):
