...
from indico.modules.events.registration.controllers.management.sections import (ManageRegFormSectionBaseMixin,
                                                                                ...
                                                                                RegistrationFormMoveSectionMixin,
                                                                                RegistrationFormToggleSectionMixin)
...
class RHCategoryRegistrationFormModifySection(RegistrationFormModifySectionMixin, RHCategoryManageRegFormSectionBase):
    """Delete/modify a section inside a category."""


class RHCategoryRegistrationFormToggleSection(RegistrationFormToggleSectionMixin, RHCategoryManageRegFormSectionBase):
    """Enable/disable a section inside a category."""


class RHCategoryRegistrationFormMoveSection(RegistrationFormMoveSectionMixin, RHCategoryManageRegFormSectionBase):
    """Move a section within the registration form inside a category."""
