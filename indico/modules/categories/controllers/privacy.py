...
from indico.modules.events.management.controllers.privacy import PrivacyMixin
from indico.web.flask.util import url_for
from indico.web.forms.base import FormDefaults


class RHCategoryPrivacy(PrivacyMixin, RHManageCategoryBase):
    """Show category privacy dashboard."""

    def _get_privacy_data(self):
        privacy_data, inherited_from = get_category_privacy(self.category)
        return privacy_data, (inherited_from if inherited_from != self.category else None)
