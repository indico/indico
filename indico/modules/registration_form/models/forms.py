...
from indico.modules.registration_form.models.form_fields import RegistrationFormPersonalDataField
...
class RegistrationForm(db.Model):
    ...
    __table_args__ = (db.Index('ix_uq_forms_participation', 'event_id', unique=True,
                      ...
                      db.CheckConstraint('template_id != id', 'not_created_from_self'),
