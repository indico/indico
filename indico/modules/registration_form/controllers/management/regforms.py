...
from indico.modules.registration_form.forms import RegistrationFormCreateForm, RegistrationFormEditForm
from indico.modules.registration_form.models.forms import RegistrationForm
from indico.modules.registration_form.operations import update_registration_form_settings
...
class RegistrationFormCreateMixin(ManageRegistrationFormsAreaMixin):
    ...
    def _process(self):
        ...
        if form.validate_on_submit():
            ...
            return redirect(url_for('registration_form.manage_regform', regform))
        if self.object_type == 'event':
