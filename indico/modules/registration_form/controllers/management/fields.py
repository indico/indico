...
from indico.modules.registration_form.controllers.management.sections import ManageRegFormSectionBaseMixin
from indico.modules.registration_form.fields import get_field_types
from indico.modules.registration_form.models.form_fields import RegistrationFormField
from indico.modules.registration_form.models.items import RegistrationFormItemType, RegistrationFormText
from indico.modules.registration_form.util import get_flat_section_positions_setup_data, update_regform_item_positions
...
class GeneralFieldDataSchema(mm.Schema):
    ...
    def _check_show_if_id(self, field_id, **kwargs):
        from indico.modules.registration_form.models.form_fields import RegistrationFormItem
        if field_id is None:
            return
        field = self.context['field']
