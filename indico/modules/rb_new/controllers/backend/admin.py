...
class RHUpdateRoom(RHRoomAdminBase):
    @use_args({
        ...
        'notifications_enabled': fields.Bool(),
        'notification_before_end_daily': fields.Int(validate=lambda x: 1 <= x <= 30, allow_none=True),
        'notification_before_end_weekly': fields.Int(validate=lambda x: 1 <= x <= 30, allow_none=True),
        'notification_before_end_monthly': fields.Int(validate=lambda x: 1 <= x <= 30, allow_none=True),
        'notifications_before_end_enabled': fields.Bool(),
