...
_bp.add_url_rule('/api/rooms/search-new', 'search_rooms_new', rooms.RHSearchRoomsNew)
...
_bp.add_url_rule('/api/map/rooms', 'map_rooms', rooms.RHSearchMapRooms)
...
_bp.add_url_rule('/api/buildings', 'buildings', locations.RHBuildings)
_bp.add_url_rule('/api/timeline', 'timeline', bookings.RHTimeline)
_bp.add_url_rule('/api/calendar', 'calendar', bookings.RHCalendar)
