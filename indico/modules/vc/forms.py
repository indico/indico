...
class VCPluginSettingsFormBase(IndicoForm):
    managers = PrincipalField(_('Managers'), groups=True, allow_external=False, description=_('Service managers'))
    acl = PrincipalField(_('ACL'), groups=True, allow_external=False,
