...
<%block name="first_page">
    <%include file="inc/first_page.tpl" args="event=event,title=_('Book of Abstracts'),show_dates=True"/>
</%block>
...
<%block name="book_body">
    % for contrib in contribs:
        % if contrib.can_access(_session.user):
            \fancyhead[L]{\small \rmfamily \color{gray} \truncateellipses{${event.title | latex_escape}}{300pt} / ${_("Book of Abstracts") | latex_escape}}
            \fancyhead[R]{}
