...
\JINJA{macro render_abstract(abstract, track_class, contrib_type, management=false, status=none, track_judgments=none)}
    ...
    \VAR{(_('Submitted by {0} on {1}')|latex(true)).format(
        ...
        '\\textbf{%s}'|rawlatex|format(abstract.submitted_dt|format_date(format='full'))
    )|rawlatex}
    \JINJA{if abstract.modified_dt}
        \fancyfoot[C]{\color{gray} \VAR{_('Last modified:')} \VAR{abstract.modified_dt|format_date(format='full')}}
    \JINJA{endif}
\JINJA{endmacro}
