...
@pytest.fixture
def create_event(dummy_user, dummy_category, db, dummy_registration_check_type):
    ...
    def _create_event(id_=None, creator=None, creator_has_privileges=False, **kwargs):
        ...
        kwargs.setdefault('default_check_type_id', dummy_registration_check_type.id)
...
@pytest.fixture
def dummy_registration_check_type(create_registration_check_type):
