...
pytest_plugins = ('indico.testing.fixtures.abstract', 'indico.testing.fixtures.app', 'indico.testing.fixtures.cache',
                  ...
                  'indico.testing.fixtures.oauth', 'indico.testing.fixtures.paper', 'indico.testing.fixtures.person',
                  'indico.testing.fixtures.user', 'indico.testing.fixtures.event', 'indico.testing.fixtures.rb',
                  'indico.testing.fixtures.smtp', 'indico.testing.fixtures.storage',
